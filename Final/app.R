...
ui <- fluidPage(
    ...
    shinyUI(navbarPage("141B Final", id = "tabs",
                       ...
                       tabPanel("About", 
                                ...
                                tags$p("For a drink / cocktail, you're able to search for an ID by a category or ingredient, then enter the ID to find the drink name, serving glass, and instructions."),
